...
class DagRunner:
    ...
    def run(
        ...
        retries: int = 0,
        parallel: bool = False,  # placeholder; batches are sequential for now
                    ...
                    if tool:
                        ...
                        if div[0]:
                            ...
                            if rollback_on_failure:
                                results.append({"action": "rollback", "status": "simulated", "details": "Rollback triggered due to failure"})
                        ...
                        # Non-tool step: simulate success
        ...
        # Exceeded retries; return last observed results/failures
