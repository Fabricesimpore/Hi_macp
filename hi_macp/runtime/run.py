...
from hi_macp.core.logger import log_run
from hi_macp.dag.executor import DagExecutor
from hi_macp.agents.ci_classifier_agent import CICLassifierAgent
from hi_macp.core.policy_validator import PolicyValidator
from hi_macp.dag.runner import DagRunner
from hi_macp.core.execution_log import ExecutionLog
...
def main() -> None:
    ...
    ci_classifier = CICLassifierAgent(manager)
